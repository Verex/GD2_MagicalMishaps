...
public class Mage : NetworkNPC
{
    [SerializeField] private Vector2 viewDistance = new Vector2(2, 2);
    [SerializeField] private float maxTargetDistance = 2.0f;
	[SerializeField] private float rangedAttackDistance = 4.0f;
    [SerializeField] private float attackDelay = 1.0f;
    [SerializeField] private float meleeAttackDelay = 1.0f;
    [SerializeField] private float attackProjectileSpeed = 1.0f;
    ...
    private IEnumerator FindPlayer()
    {
        ...
        if (distance <= maxTargetDistance)
        {
            ...
            RaycastHit2D hit = Physics2D.Raycast(transform.position, facing, rangedAttackDistance, LayerMask.GetMask("Characters"));
            ...
            if (hit.collider != null)
            {
                ...
                if (hit.collider.tag == "Player")
                {
                    ...
                    // Check if player within melee range.
